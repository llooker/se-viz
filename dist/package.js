    ...
    update: function (data, element, config, queryResponse) {
        ...
        var color = colorScale.range(config.color_range);
            ...
            row.taxonomy = {
				...
				var format = __WEBPACK_IMPORTED_MODULE_0_d3__["format"](",d")
				var bubble = __WEBPACK_IMPORTED_MODULE_0_d3__["pack"]()
    .size([width, height])
    .padding(1.5);
		...
		var svg = (this.svg
		    ...
		    .attr('transform', 'translate(' + 0 + ',' + 0 + ')'));
				...
				var root = __WEBPACK_IMPORTED_MODULE_0_d3__["hierarchy"](obj)
...
.attr("cy", function(d) {
	return d.y;
				      ...
				      .style("stroke", function(d) { return  __WEBPACK_IMPORTED_MODULE_0_d3__["rgb"](color(d.data.packageName)).darker(); })
	...
	return d.y + 5;
				 ...
				 //  $("circle").tooltip({container: '.bubble_chart', html: true, placement:'top'});
				  // $("text").tooltip({container: '.bubble_chart', html: true, placement:'top'});
					...
					function wrap(d) {
			        var text = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this),
			          width = d.r * 2,
			          x = d.x,
			          y = d.y,
